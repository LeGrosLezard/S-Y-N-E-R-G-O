...
subtractor = cv2.createBackgroundSubtractorMOG2(history=120,
                                                varThreshold = 20,
                                                detectShadows=False)
...
while True:
    ...
    if landmarks is not None:
        ...
        face_movements(landmarks, frame, head_box, subtractor)
        ...
        #Recuperate face movements
        face_movements(None, frame, head_box, subtractor)
