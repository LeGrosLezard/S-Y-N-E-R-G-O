...
def resize_frame(frame):
    ...
    nb = 1.515 #h, c
    #nb = 1.5000000000000007#j, m
    #nb = 2.2#n
    #nb = 1.3000000000000005#r

    #nb = 1.7500000000000009#s


    #nb = 1.1000000000000003#af
    #nb = 1.3500000000000005#bf
    #nb = 2#cf

    #nb =  1.3500000000000005#t/v
    
    #nb = 1.4000000000000006#u
    #nb = 2
